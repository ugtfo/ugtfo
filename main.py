...
def main():
    ...
    create_button("Добавить линию", lambda arg1=line_list, arg2=entry_line_start,
                  arg3=entry_line_stop, arg4=canvas_class: add_line(arg1, arg2, arg3, arg4), [1000, 275])

    create_label(root, "Координаты контура:", [1010, 350])
    create_label(root, "Координаты двух противоположных вершин", [1010, 400])
    create_label(root, "Координаты 1-ой вершины х у через пробел:", [1010, 450])
    entry_contour_start = create_entry(root, [1000, 500])
    create_label(root, "Координаты 2-ой вершины х у через пробел:", [1010, 550])
    entry_contour_stop = create_entry(root, [1000, 600])
    create_button("Добавить контур", lambda arg1=contour, arg2=entry_contour_start,
                  arg3=entry_contour_stop, arg4=canvas_class: add_contour(arg1, arg2, arg3, arg4), [1000, 650])

    create_button("Отсечь", lambda arg1=canvas_class, arg2=line_list, arg3=contour:
                  solution_wrapper(arg1, arg2, arg3), [1000, 700])

    create_button("Очистить", lambda arg1=canvas_class, arg2=line_list:
